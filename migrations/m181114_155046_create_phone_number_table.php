 ...
 */
class m181114_155046_create_phone_number_table extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->createTable('phone_number', [
            ...
            'country_id' => $this->integer(10)->unsigned()->notNull(),
            'number' => $this->string(45),
            'varification_code' => $this->string(45),
            'varified' => $this->boolean()->notNull()->defaultValue('0'),
